...
SELECT
  ...
  LOWER(decoded_flat :tokens [0] :: STRING) AS token0,
  LOWER(decoded_flat :tokens [1] :: STRING) AS token1,
  LOWER(decoded_flat :tokens [2] :: STRING) AS token2,
  LOWER(decoded_flat :tokens [3] :: STRING) AS token3,
  LOWER(decoded_flat :tokens [4] :: STRING) AS token4,
  LOWER(decoded_flat :tokens [5] :: STRING) AS token5,
  LOWER(decoded_flat :tokens [6] :: STRING) AS token6,
  LOWER(decoded_flat :tokens [7] :: STRING) AS token7,
  decoded_flat :tokens AS token_array,
